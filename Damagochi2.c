...
{	
	...
	int battle_enemyhealth = 100; // 적 어카운팅 시스템 만들다보니 필요한 변수라서 초기화 해줌
	int battle_enemyattack = 40; // 적 어카운팅 시스템 만들다보니 필요한 변수라서 초기화 해줌
	...
	while (gameon) // 반복문 지속
	{
		...
		// 입력해달라는 안내 메시지를 출력
		printf("===================================================\n");
		printf("1.잠자기 2.응가하기 3.밥주기 4.산책하기 5.터그놀이 6.상점\n");
		printf("===================================================\n");
		printf("입력: ");
