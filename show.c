...
{
	printf("\n==============================================================================================================================\n");
	printf("1.잠자기 2.응가하기 3.밥주기 4.산책하기 5.터그놀이 6.상점 7.다마고치 가이드라인 8.스킬강화 9.스킬정보 10.이름변경 11.포획관리\n");
	printf("================================================================================================================================\n");
}
// 이름 변경 서브 메뉴 표시 함수 추가
void ShowRenameMenu()
{
    printf("\n=== 이름 변경 메뉴 ===\n");
    printf("1. 다마고치 이름 변경\n");
...
{
    printf("\n=== 포획 관리 메뉴 ===\n");
    printf("1. 포획된 다마고치 목록 보기\n");
    printf("2. 다마고치 교체하기\n");
    printf("3. 포획된 다마고치 정보 보기\n");
    printf("0. 돌아가기\n");
    printf("선택: ");
}